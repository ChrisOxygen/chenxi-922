...
export const COPY = {
  ...
  // Benefits section
  BENEFITS_HEADING: "Why Azure Steel is Different from Everything Else...",
...
export const QUANTITY_OPTIONS = [
  {
    value: "1",
    label: `1 ${PRODUCT.NAME} watch + FREE Sterling steel bracelet = ${formatNaira(PRICING.OFFER)}`,
  },
  {
    value: "2",
    label: `2 ${PRODUCT.NAME} watches + FREE Sterling steel bracelet = ${formatNaira(PRICING.OFFER * 2)}`,
  },
];
