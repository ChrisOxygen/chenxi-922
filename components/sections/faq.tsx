    ...
    <div className="border-b border-brand-primary/20">
      ...
      >
        <span
          className={`font-heading text-base sm:text-xl font-semibold transition-colors duration-300 ${
            isOpen ? "text-brand-primary-light" : "text-brand-primary"
          }`}
        >
          {faq.question}
        </span>
      ...
      >
        <div className="overflow-hidden">
          <p className="border-t border-brand-primary px-4 py-4 text-lg text-brand-primary-light bg-brand-surface">
            {faq.answer}
          </p>
        </div>
      </div>
